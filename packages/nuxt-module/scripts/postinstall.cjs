...
function copy(src, dest) {
  ...
  console.log(`[@ku-utils/nuxt-module] ✅ 已安装: ${path.relative(projectRoot, dest)}`)
}
...
try { copy(path.join(pkgRoot,'skills','nuxt-module','SKILL.md'), path.join(projectRoot,'.cursor','skills','nuxt-module','SKILL.md')) } catch(e){}
