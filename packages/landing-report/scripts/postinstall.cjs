...
function copy(src, dest) {
  ...
  console.log(`[@ku-utils/landing-report] ✅ 已安装: ${path.relative(projectRoot, dest)}`)
}
...
try { copy(path.join(pkgRoot,'skills','landing-report','SKILL.md'), path.join(projectRoot,'.cursor','skills','landing-report','SKILL.md')) } catch(e){}
