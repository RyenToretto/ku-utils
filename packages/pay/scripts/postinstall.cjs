...
function copy(src, dest) {
  ...
  console.log(`[@ku-utils/pay] ✅ 已安装: ${path.relative(projectRoot, dest)}`)
}
...
try { copy(path.join(pkgRoot,'skills','pay','SKILL.md'), path.join(projectRoot,'.cursor','skills','pay','SKILL.md')) } catch(e){}
