...
function copy(src, dest) {
  ...
  console.log(`[@ku-utils/hooks] ✅ 已安装: ${path.relative(projectRoot, dest)}`)
}
...
try { copy(path.join(pkgRoot,'skills','hooks','SKILL.md'), path.join(projectRoot,'.cursor','skills','hooks','SKILL.md')) } catch(e){}
