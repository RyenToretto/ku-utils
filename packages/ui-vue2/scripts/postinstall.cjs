...
function copy(src, dest) {
  ...
  console.log(`[@ku-utils/ui-vue2] ✅ 已安装: ${path.relative(projectRoot, dest)}`)
}
...
try { copy(path.join(pkgRoot,'skills','ui-vue2','SKILL.md'), path.join(projectRoot,'.cursor','skills','ui-vue2','SKILL.md')) } catch(e){}
