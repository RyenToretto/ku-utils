...
function copy(src, dest) {
  ...
  console.log(`[@ku-utils/directives] ✅ 已安装: ${path.relative(projectRoot, dest)}`)
}
...
try { copy(path.join(pkgRoot,'skills','directives','SKILL.md'), path.join(projectRoot,'.cursor','skills','directives','SKILL.md')) } catch(e){}
