...
const props = withDefaults(defineProps<Props>(), {
  ...
  borderWidth: '1px',
  shadow:
    'inset 0 0 2px 1px color-mix(in srgb, var(--ku-bg-card, #ffffff) 68%, transparent), inset 0 0 10px 4px color-mix(in srgb, var(--ku-bg-card, #ffffff) 28%, transparent), 0 8px 28px color-mix(in srgb, var(--ku-neutral-900, #171717) 8%, transparent), 0 14px 44px color-mix(in srgb, var(--ku-neutral-900, #171717) 6%, transparent)',
