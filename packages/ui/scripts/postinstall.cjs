...
function copy(src, dest) {
  ...
  console.log(`[@ku-utils/ui] ✅ 已安装: ${path.relative(projectRoot, dest)}`)
}
...
try { copy(path.join(pkgRoot,'skills','ui','SKILL.md'), path.join(projectRoot,'.cursor','skills','ui','SKILL.md')) } catch(e){}
