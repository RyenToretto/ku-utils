...
function copy(src, dest) {
  ...
  console.log(`[@ku-utils/i18n] ✅ 已安装: ${path.relative(projectRoot, dest)}`)
}
...
try { copy(path.join(pkgRoot,'skills','i18n','SKILL.md'), path.join(projectRoot,'.cursor','skills','i18n','SKILL.md')) } catch(e){}
