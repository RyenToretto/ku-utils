...
function copy(src, dest) {
  ...
  console.log(`[@ku-utils/tsconfig] ✅ 已安装: ${path.relative(projectRoot, dest)}`)
}
...
try { copy(path.join(pkgRoot,'skills','tsconfig','SKILL.md'), path.join(projectRoot,'.cursor','skills','tsconfig','SKILL.md')) } catch(e){}
