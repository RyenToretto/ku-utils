...
function copy(src, dest) {
  ...
  console.log(`[@ku-utils/request] ✅ 已安装: ${path.relative(projectRoot, dest)}`)
}
...
try { copy(path.join(pkgRoot,'skills','request','SKILL.md'), path.join(projectRoot,'.cursor','skills','request','SKILL.md')) } catch(e){}
