...
function copy(src, dest) {
  ...
  console.log(`[@ku-utils/report] ✅ 已安装: ${path.relative(projectRoot, dest)}`)
}
...
try { copy(path.join(pkgRoot,'skills','report','SKILL.md'), path.join(projectRoot,'.cursor','skills','report','SKILL.md')) } catch(e){}
